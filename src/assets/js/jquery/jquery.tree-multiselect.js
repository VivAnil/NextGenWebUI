...
exports.createSelected = function (option, disableRemoval, showSectionOnSelected) {
  ...
  if (showSectionOnSelected) {
      ...
      var checkBox = exports.createNode('input', { type: 'checkbox' });             // By Amrit
      var checkBox1 = exports.createNode('input', { type: 'checkbox' });
      var checkBox3 = exports.createNode('input', { type: 'checkbox' });
    node.appendChild(sectionSpan);
    node.appendChild(checkBox);
    node.appendChild(checkBox1);
    node.appendChild(checkBox3);
  }
